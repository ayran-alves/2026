...
export default function Contador() {
  ...
  return (
    <View style={estilos.container}>
      ...
      <TouchableOpacity style={estilos.botaoDiminuir}>
        <Text style={estilos.botaoTexto} onPress={() => setContador(contador - 1)}>Diminuir</Text>
      </TouchableOpacity>

      <TouchableOpacity style={estilos.botaoReset} onPress={() => setContador(contador - contador )}>
